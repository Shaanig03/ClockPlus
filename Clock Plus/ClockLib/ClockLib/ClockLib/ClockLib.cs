                ...
                foreach (KeyValuePair<int, AlarmItemDef> keyValue in ClockLib.timerDefs)
                {
                    ...
                    if (flag2)
                    {
                        ...
                        if (flag3)
                        {
                            ...
                            mainController.ShowNotification(keyValue.Value, ClockNotificationType.Timer);
            ...
            else
            {
                ...
                foreach (ClockItem _clockItem in ClockLib.clockItems)
                {
                    ...
                    if (flag2)
                    {
                        ...
                        if (_ntfData != null)
                        {
                            mainController.ShowNotification((AlarmItemDef)_ntfData, ClockNotificationType.Alarm);
                        }
                        /*
